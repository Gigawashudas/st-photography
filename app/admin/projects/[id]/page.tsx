...
export default async function AdminProjectEditPage({ params }: ProjectPageProps) {
  ...
  return (
    <main className="bg-background text-foreground min-h-screen transition-colors duration-500">
      <div className="mx-auto w-full max-w-360 px-5 py-6 sm:px-8 sm:py-8 lg:px-10 lg:py-10">
        ...
        <section className="pt-16 sm:pt-24 lg:pt-32">
          ...
          <h1 className="font-serif text-[clamp(3.75rem,12vw,9rem)] leading-[0.8] tracking-[-0.055em]">
            Edit.
          </h1>

          <p className="text-secondary mt-7 max-w-xl text-sm leading-7 sm:mt-8 sm:text-base sm:leading-8">
            Update the project information, images, YouTube video, publication status, and featured
            placement.
          </p>
        </section>
