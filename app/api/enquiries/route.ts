...
const enquirySchema = z.object({
  ...
  service: z.enum(["Photography", "Cinematography", "Event", "Portrait", "Interior", "Other"]),
  ...
  message: z.string().trim().min(10, "Please tell us a little more about your project.").max(3000, "Message is too long."),
});
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const { website, name, email, phone, service, projectDate, location, budget, message } = result.data;
