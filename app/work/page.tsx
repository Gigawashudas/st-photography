                  ...
                  <Link href={`/work/${project.slug}`} className="group block">
                    <div className="relative overflow-hidden bg-subtle">
                      <div className={`relative ${isWide ? "aspect-[16/10]" : index % 2 === 0 ? "aspect-[4/5]" : "aspect-[3/4]"}`}>
                        <Image src={project.coverImage} alt={project.title} fill sizes={isWide ? "(max-width: 768px) 100vw, 72vw" : "(max-width: 768px) 100vw, 50vw"} className="object-cover transition-transform duration-[1200ms] ease-out group-hover:scale-[1.035]" />
