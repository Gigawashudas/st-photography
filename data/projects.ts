...
export const projects: Project[] = [
  {
    ...
    year: 2026,
    description:
      'A quiet residential interior shaped by natural light, warm materials, and restrained architectural details.',
    coverImage:
  ...
  },
  {
    ...
    year: 2026,
    description:
      'Contemporary architecture photographed through geometry, shadow, texture, and afternoon light.',
    coverImage:
  ...
  },
  {
    ...
    year: 2026,
    description:
      'Organic textures, natural materials, and architectural forms captured in a warm visual language.',
    coverImage:
  ...
  },
  {
    ...
    coverImage:
      'https://images.unsplash.com/photo-1600607688960-e095ff83135c?auto=format&fit=crop&w=2000&q=90',
    featured: false,
    featuredOrder: 0,
    published: true,
    images: [
  ...
  },
  {
    ...
    year: 2026,
    description:
      'An evening interior film focused on ambient lighting, mood, and architectural details.',
    coverImage:
      'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=2000&q=90',
    featured: false,
    featuredOrder: 0,
